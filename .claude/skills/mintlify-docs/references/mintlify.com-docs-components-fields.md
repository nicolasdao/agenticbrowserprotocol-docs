---
url: https://mintlify.com/docs/components/fields
canonical: https://www.mintlify.com/docs/components/fields
title: "Fields - Mintlify"
...
The `<ParamField>` component is used to define parameters for your APIs or SDKs. Adding a `ParamField` automatically adds an [API Playground](https://www.mintlify.com/docs/api-playground/overview).
...
[​](#param-query-path-body-or-header)
...
Expected type of the parameter’s value.Supports `number`, `string`, `boolean`, `object`.Arrays can be defined using the `[]` suffix. For example `string[]`.
...
[ExpandablesPrevious](https://www.mintlify.com/docs/components/expandables)[FramesNext](https://www.mintlify.com/docs/components/frames)
