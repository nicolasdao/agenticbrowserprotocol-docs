---
url: https://mintlify.com/docs/guides/git-concepts
canonical: https://www.mintlify.com/docs/guides/git-concepts
title: "Git concepts for documentation - Mintlify"
...
The [web editor](https://www.mintlify.com/docs/editor/index) handles Git operations automatically.
...
The web editor connects to your Git repository through the [GitHub App](https://www.mintlify.com/docs/deploy/github) or [GitLab integration](https://www.mintlify.com/docs/deploy/gitlab) and automates common Git operations. When you:
...
[Understand your audiencePrevious](https://www.mintlify.com/docs/guides/understand-your-audience)[Work with branchesNext](https://www.mintlify.com/docs/guides/branches)
