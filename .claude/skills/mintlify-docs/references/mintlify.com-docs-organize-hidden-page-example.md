---
url: https://mintlify.com/docs/organize/hidden-page-example
canonical: https://www.mintlify.com/docs/organize/hidden-page-example
title: "Hidden page example - Mintlify"
...
This page is hidden! It is not included in the `docs.json` navigation so you can only access it by its URL. See [Hidden pages](https://www.mintlify.com/docs/organize/hidden-pages) for more information.
...
By default, hidden pages are publicly accessible, but not discoverable through the navigation. If you want to restrict access to a hidden page, you must configure [authentication](https://www.mintlify.com/docs/deploy/authentication-setup).
