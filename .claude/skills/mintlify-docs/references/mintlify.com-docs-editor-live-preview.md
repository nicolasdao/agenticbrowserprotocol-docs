---
url: https://mintlify.com/docs/editor/live-preview
canonical: https://www.mintlify.com/docs/editor/live-preview
title: "Live preview - Mintlify"
...
- Web editor
    ...
    -   [Overview](https://www.mintlify.com/docs/editor)
    -   [Create and edit pages](https://www.mintlify.com/docs/editor/pages)
    -   [Add media](https://www.mintlify.com/docs/editor/media)
    -   [Organize navigation](https://www.mintlify.com/docs/editor/navigation)
    -   [Configurations](https://www.mintlify.com/docs/editor/configurations)
    -   [Live preview](https://www.mintlify.com/docs/editor/live-preview)
    -   [Collaborate](https://www.mintlify.com/docs/editor/collaborate)
    -   [Publish](https://www.mintlify.com/docs/editor/publish)
    -   [Keyboard shortcuts](https://www.mintlify.com/docs/editor/keyboard-shortcuts)
...
Click the play button in the toolbar to open a live preview in a new tab.

![Live preview button on the editor toolbar.](https://mintcdn.com/mintlify/bV--4TpbjuI-NlIg/images/editor/live-preview-light.png?fit=max&auto=format&n=bV--4TpbjuI-NlIg&q=85&s=2480f108ebb2a70cc15bf67a789ceac1)![Live preview button on the editor toolbar.](https://mintcdn.com/mintlify/bV--4TpbjuI-NlIg/images/editor/live-preview-dark.png?fit=max&auto=format&n=bV--4TpbjuI-NlIg&q=85&s=f9ab90117dffac2f7af53494f10595a3)
...
[ConfigurationsPrevious](https://www.mintlify.com/docs/editor/configurations)[Collaborate in the web editorNext](https://www.mintlify.com/docs/editor/collaborate)

⌘I

![Live preview button on the editor toolbar.](https://mintcdn.com/mintlify/bV--4TpbjuI-NlIg/images/editor/live-preview-dark.png?w=1650&fit=max&auto=format&n=bV--4TpbjuI-NlIg&q=85&s=bfc92f592d8fcef7b8d0dcb9c5235daf)
