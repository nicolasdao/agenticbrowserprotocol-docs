---
url: https://mintlify.com/docs/components/tiles
canonical: https://www.mintlify.com/docs/components/tiles
title: "Tiles - Mintlify"
...
Use tiles to create visual showcase elements with a patterned background, title, and description. Tiles are ideal for displaying component previews, feature highlights, or navigation items in a grid layout. [AccordionTwo variants](https://www.mintlify.com/docs/components/accordions)
...
Combine tiles with the [columns component](https://www.mintlify.com/docs/components/columns) to create a responsive grid of visual previews.

[AccordionTwo variants](https://www.mintlify.com/docs/components/accordions)[AccordionTwo variants](https://www.mintlify.com/docs/components/accordions)[AccordionTwo variants](https://www.mintlify.com/docs/components/accordions)
...
[TabsPrevious](https://www.mintlify.com/docs/components/tabs)[TooltipsNext](https://www.mintlify.com/docs/components/tooltips)
