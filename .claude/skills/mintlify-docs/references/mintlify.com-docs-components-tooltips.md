---
url: https://mintlify.com/docs/components/tooltips
canonical: https://www.mintlify.com/docs/components/tooltips
title: "Tooltips - Mintlify"
...
Use tooltips to provide additional context or definitions when a user hovers over a string of text. Tooltips can include optional call-to-action links. **Example**: API documentation helps developers understand how to integrate with your service.
...
[TilesPrevious](https://www.mintlify.com/docs/components/tiles)[TreeNext](https://www.mintlify.com/docs/components/tree)
