---
url: https://mintlify.com/docs/organize/mintignore
canonical: https://www.mintlify.com/docs/organize/mintignore
title: "Exclude files from publishing - Mintlify"
...
- Are ignored by [broken link checks](https://www.mintlify.com/docs/installation#find-broken-links). Links that point to ignored files are broken.
...
Unlike [hidden pages](https://www.mintlify.com/docs/organize/hidden-pages), files excluded by `.mintignore` are completely removed from your site and cannot be accessed by URL.
...
[Hidden pagesPrevious](https://www.mintlify.com/docs/organize/hidden-pages)[Custom domainNext](https://www.mintlify.com/docs/customize/custom-domain)
