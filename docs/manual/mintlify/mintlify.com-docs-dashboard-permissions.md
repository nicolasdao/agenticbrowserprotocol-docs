---
url: https://mintlify.com/docs/dashboard/permissions
canonical: https://www.mintlify.com/docs/dashboard/permissions
title: "Deployment permissions - Mintlify"
