---
url: https://mintlify.com/docs/components/accordions
canonical: https://www.mintlify.com/docs/components/accordions
title: "Accordions - Mintlify"
...
- [Font Awesome](https://fontawesome.com/icons) icon name, if you have the `icons.library` [property](https://www.mintlify.com/docs/organize/settings#param-icons) set to `fontawesome` in your `docs.json`
- [Lucide](https://lucide.dev/icons) icon name, if you have the `icons.library` [property](https://www.mintlify.com/docs/organize/settings#param-icons) set to `lucide` in your `docs.json`
- [Tabler](https://tabler.io/icons) icon name, if you have the `icons.library` [property](https://www.mintlify.com/docs/organize/settings#param-icons) set to `tabler` in your `docs.json`
...
[OverviewPrevious](https://www.mintlify.com/docs/components)[BadgeNext](https://www.mintlify.com/docs/components/badge)
