---
url: https://mintlify.com/docs/components/panel
canonical: https://www.mintlify.com/docs/components/panel
title: "Panel - Mintlify"
...
You can use the `<Panel>` component to customize the right side panel of a page with any components that you want. If a page has a `<Panel>` component, any [RequestExample](https://www.mintlify.com/docs/components/examples#request-example) and [ResponseExample](https://www.mintlify.com/docs/components/examples#response-example) components must be inside `<Panel>`. The components in a `<Panel>` will replace a page’s table of contents.
```
<Panel>
...
[MermaidPrevious](https://www.mintlify.com/docs/components/mermaid-diagrams)[PromptNext](https://www.mintlify.com/docs/components/prompt)
