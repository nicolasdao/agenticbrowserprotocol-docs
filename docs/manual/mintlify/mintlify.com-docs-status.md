---
url: https://mintlify.com/docs/status
canonical: https://www.mintlify.com/docs/status
title: "Status page - Mintlify"
...
Visit [status.mintlify.com](https://status.mintlify.com) to view the current status of Mintlify services. The status page displays the operational status of:
